...
export async function seedDemoProject({
  ...
  const serviceCharges = [
    ...
    },
    {
      ...
      basisAmount: 1950000,
      percentage: 5,
      serviceChargeAmount: 97500,
      includedInDemand: true,
      status: 'APPROVED',
      settlementStatus: 'INCLUDED_IN_DEMAND',
      approvedAt: new Date('2026-05-08T00:00:00.000Z'),
      notes: 'Included in first-slab demand batch.',
    },
    {
      id: 'demo-sc-manual',
      phaseId: null,
  ...
  const auditEntries = [
    {
      ...
      newValues: { title: 'Piling Phase Bill', total: 1680000 },
    ...
    },
    {
      ...
      newValues: { serviceChargeAmount: 67500, includedInDemand: true },
