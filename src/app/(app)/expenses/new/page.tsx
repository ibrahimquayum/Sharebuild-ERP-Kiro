...
export default function AddExpensePage() {
  ...
  const showQuantityFields = [
    'ROD_STEEL','CEMENT','STONE_AGGREGATE','SAND','BRICK',
    'READYMIX_CONCRETE','TIMBER_SHUTTERING','PAINT','TILES',
    'HARDWARE','TRANSPORT',
  ].includes(category);
      ...
      <div className="p-6 max-w-2xl mx-auto w-full space-y-4">
        ...
        <Card>
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              Record any site cost — materials, labour, bills, or overhead.
              Admins &amp; managers are approved automatically; others go to the approval queue.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} noValidate className="space-y-6">
              ...
              <FormSection title="Expense Details">
                <TextField
                  ...
                  id="description"
                  required
                  placeholder="e.g. Cement purchase from ABC Supplier"
                  value={description}
                ...
                {/* Quantity section — shown for material categories */}
                {showQuantityFields && (
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <TextField
                      ...
                      hint="Amount is auto-calculated"
                    />
                  </div>
                )}
