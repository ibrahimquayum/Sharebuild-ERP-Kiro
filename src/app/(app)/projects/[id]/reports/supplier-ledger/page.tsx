        ...
        <section key={assignment.id} className="space-y-3 rounded-md border p-4 print:break-inside-avoid">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              ...
              <tbody>
                {assignment.payables.length === 0 ? <tr><td colSpan={8} className="px-3 py-6 text-center text-muted-foreground">No supplier bills yet.</td></tr> : assignment.payables.map((payable) => (
