...
export async function GET(req: Request, { params }: { params: { id: string } }) {
  ...
  [
    ...
    ['Supplier Bill Items', data.costReport.totals.SUPPLIER_BILL_ITEM, 'Subcontractor Bills', data.costReport.totals.SUBCONTRACTOR_BILL],
    ['Service Charge', data.costReport.totals.SERVICE_CHARGE, 'Unified Cost Total', data.costReport.totals.total],
  ...
  addTableSheet(workbook, {
    ...
    headers: ['Phase', 'Status', 'Collection', 'Direct Expense', 'Supplier Items', 'Subcontractor Bills', 'Service Charge', 'Total Billable Cost', 'Carry Out'],
  ...
  addTableSheet(workbook, {
    name: 'Daily Project Cost Details',
  ...
  addTableSheet(workbook, {
    ...
    subtitle: 'Basis, settlement, and demand inclusion visibility',
    company: data.branding.name,
    project: data.project.name,
