...
export async function GET(req: Request, { params }: { params: { id: string } }) {
  ...
  const content = [
    ...
    csvSection('Executive Summary', [
      ...
      ['Subcontractor Bills', data.costReport.totals.SUBCONTRACTOR_PROGRESS_BILL],
      ['Company Service Charge / Supervision Fee', data.costReport.totals.COMPANY_SERVICE_CHARGE],
